...
export function ThemeSwitch({ size }: ThemeSwitchProps) {
    ...
    return (
        <>
            <div className={styles.themeSwitch} onClick={() => { setTheme(theme === 'dark' ? 'light' : 'dark') }}>
                {
                    theme === 'light' ?
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={size} height={size}>
