    ...
    return (
        <>
            <div className={styles.themeSwitch} onClick={() => { setTheme(theme === 'dark' ? 'light' : 'dark') }}>
                {
                    theme === 'light' ?
                        <svg fill='#000' id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={32} height={32}>
                        ...
                        : <svg fill='#fff' id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width={32} height={32}>
